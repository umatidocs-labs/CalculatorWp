...
if ( ! defined( 'GRAVITY_MANAGER_URL' ) ) {
	 ...
	 */
	define( 'GRAVITY_MANAGER_URL', 'https://www.gravityhyelp.com/wp-content/plugins/' );
}
...
if ( ! defined( 'GRAVITY_MANAGER_PROXY_URL' ) ) {
	 ...
	 */
	define( 'GRAVITY_MANAGER_PROXY_URL', 'http://gravitypluins.com' );
}
...
class GFForms {
	...
	//	add_action( 'load-' . $forms_hook_suffix, array( 'GFForms', 'load_screen_options' ) );
		...
		/*add_menu_page(
			__( 'CalculatorWP Forms', 'gravityforms' ),
			__( 'CalculatorWP Forms', 'gravityforms' ),
			$has_full_access ? 'gform_full_access' : 'gravityforms_edit_forms',
			'gf_edit_forms',
			array(
				'GFForms',
				'forms'
		...
		*/
		add_submenu_page( 
			'mvc_calculatorwp_clientloannotes', 
			__( 'Loan Forms', 'gravityforms' ),
			__( 'Loan Forms', 'gravityforms' ),
			$has_full_access ? 'gform_full_access' : 'gravityforms_edit_forms',
			'gf_edit_forms', 
			array(
...
/*
	...
	public static function get_parent_menu( $addon_menus ) {
		...
		if ( GFCommon::current_user_can_any( 'gravityforms_edit_forms' ) ) {
			...
			$parent = array( 'name' => 'gf_edit_forms', 'callback' => array( 'GFForms', 'new_form' ) );
	...
	public static function dashboard() {
		...
		if ( sizeof( $forms ) > 0 ) {
			...
			<div class="gf_dashboard_noforms_notice">
				<?php echo sprintf( "You don't have any forms. Let's go create one!" ); ?>
			</div>
			<?php
		}
