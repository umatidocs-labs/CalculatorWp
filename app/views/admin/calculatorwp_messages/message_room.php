<div class = "wrap ">
    ...
    <br>
        <?php echo " <a class='sl_menu_sub_item' href=".mvc_admin_url(array('controller' => 'admin_calculatorwp_messages', 'action' => 'mark_as_resolved','id'=>$ticket['id'])).">Mark This As Resolved</a>"; ?>
        </center>
