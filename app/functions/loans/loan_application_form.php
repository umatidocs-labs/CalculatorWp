...
class simplelender_gravity_form_manager {
	...
	public function process_primary_form(){
        ...
        if(!isset($loan_application['goal_id'])){
            $spending_goal_id = mvc_model("simplelenderSpendingoal")->create(["simplelenderSpendingoal"=>["name"=>$param['sl_loan_goal_name'],"description"=>$param['sl_loan_goal_description'],'email'=>$param['sl_loan_app_email']]]);
        ...
        echo json_encode(["sl_new_form"=>true ]);
