<div class="calculatorwp_clientloans_more_loan_info">
...
<table class="loan_stages">
    <tr>
		...
		<td class="calculatorwp_adedcline_top">
			<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo '<a class="calculatorwp_application_top_a" href="'.mvc_admin_url(array('controller' => 'calculatorwp_clientloans', 'action' => 'goal_info','id' => $object_id)).'">Goals</a>'; ?>
		</td>
	</tr>
</table>
