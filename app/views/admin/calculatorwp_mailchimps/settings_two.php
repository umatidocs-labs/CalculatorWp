...
<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo " <a class='button-primary' href=".mvc_admin_url(array('controller' => 'admin_calculatorwp_loansettings', 'action' => 'add',)).">New Loan</a>";	?>	</div>
...
<br>
<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   
echo "<a href=".mvc_admin_url(array('controller' => 'admin_calculatorwp_links', 'action' => 'delete', 'id' => $object->__id)).">Delete</a>";
?>
