...
<div>
	...
	<div ><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo esc_html($this->form->input('term_in_years', array('placeholder' => '', 'label' => '','id'=>'date_picker'),  array('style' => 'width: 200px;')));?></div>
</div>
...
<div><br>
	...
	<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */  
		echo esc_html($this->form->hidden_input('loan_setting_id', array('value'=>$loan_setting_id),  array()));
	?>
