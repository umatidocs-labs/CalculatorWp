...
<div class="client_dash">
	...
	<div id="simplelender_dash_content">
			<div class="logout_link_wrapper">
				...
				echo "<a href='". mvc_public_url(array('controller' => 'simplelender_clientloans', 'action' => 'notification','id'=>2))."'> Notifications <b>(".$client_count.")</b> </a> | ";
		...
		<table id="simplelender_loan_dash">
			...
			<tr>
				...
				<td class="simplelender_sub_title"><center>Number of Transactions </center></td>
