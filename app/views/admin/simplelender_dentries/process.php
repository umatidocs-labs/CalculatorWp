...
<br>
	...
	<div><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo '<a href="'.mvc_admin_url(array('controller' => 'admin_simplelender_loansettings', 'action' => 'edit','id' => $object->id)).'">'.mvc_model('Loansetting')->find_by_id($object->loan_setting_id)->name.'</a>'; ?></div>	
