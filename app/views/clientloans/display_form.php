...
<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   
	echo esc_html("<a class='button-primary' href=".mvc_admin_url(array('controller' => 'admin_clientloans', 'action' => '',)).">Transactions for this Loan</a><br>");	
?>
...
<?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo  do_shortcode('[gravityform id="1" title="true" description="true" ajax="false"]'); ?>
...
<br>
	...
	<div><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo '<a href="'.esc_html(mvc_admin_url(array('controller' => 'admin_loansettings', 'action' => 'edit','id' => $object->id)).'">'.mvc_model('Loansetting')->find_by_id($object->loan_setting_id)->name).'</a>'; ?></div>	
