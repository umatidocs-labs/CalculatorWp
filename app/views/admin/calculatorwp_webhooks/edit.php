...
<center><h2 class="calculatorwp_main_title"> Edit Custom Email </h2>
<?php echo '<a class="button" href="'.mvc_admin_url(array("controller" => "calculatorwp_webhooks", "action" => "resend_failed_webhook", "id" =>$object->id)).'"><b>Resend failed events </b></a>'; ?>
<?php echo '<a class="button" href="'.mvc_admin_url(array("controller" => "calculatorwp_webhooks", "action" => "view_logs", "id" =>$object->id)).'"><b>View Logs</b></a>'; ?>
<br><br><br>

<b>Active Retrys:</b> <?php echo calculatorwp_class('calculatorwp_events_manager')->WebhookLog_unsuccessful_count($object->id); ?>
...
<hr>
	...
	<div><?php echo $this->form->editor('mail_body',array('label' => '','class'=>'calculatorwp_input_feild')); ?></div>
