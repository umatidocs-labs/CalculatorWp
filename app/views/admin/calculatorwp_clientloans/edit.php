...
<center><h3 class="calculatorwp_main_title"> Manage Loan Flow</h3></center>
...
<tr>
	...
	<td class="calculatorwp_title_feild"><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo $this->form->select_from_model('client_id',$client_id, array(), array('label' => '','class'=>'calculatorwp_input_feild')); ?></td>
</tr><tr>
	<td class="calculatorwp_title_feild">Loan Product</td>
	<td class="calculatorwp_title_feild"><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo $this->form->select_from_model('loan_setting_id',$loan_setting, array(), array('label' => '','class'=>'calculatorwp_input_feild')); ?></td>
</tr>
</tbody>
</table>
